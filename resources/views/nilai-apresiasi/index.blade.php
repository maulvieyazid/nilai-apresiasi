                                    ...
                                    @foreach ($semuaApresiasiMhs as $apresiasiMhs)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div>
                                                    <!-- Tombol Edit -->
                                                    <a href="{{ route('nilaiapresiasi.edit', $apresiasiMhs->id_apresiasi) }}" class="btn icon btn-sm btn-warning text-dark">
                                                    ...
                                                    <!-- Tombol Hapus -->
                                                    <button type="button" class="btn icon btn-sm btn-danger" onclick="hapus(this, {{ $apresiasiMhs->toJson() }})">
